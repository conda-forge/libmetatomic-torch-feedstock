...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/libmetatomic-torch-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/libmetatomic-torch-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add libmetatomic-torch
# for installing globally
pixi global install libmetatomic-torch
```
...
It is possible to list all of the versions of `libmetatomic-torch` available on your platform:
...
```
pixi search libmetatomic-torch --channel conda-forge
```
